		...
		case "Dur":
			{
				...
				if err != nil {
					err = msgp.WrapError(err, "Dur")
					return
				}
				z.Dur = _decodeTimeDuration(zb0002)
			}
		default:
			err = dc.Skip()
			if err != nil {
...
func (z TestRet) EncodeMsg(en *msgp.Writer) (err error) {
	...
	// write "Dur"
	err = en.Append(0xa3, 0x44, 0x75, 0x72)
	if err != nil {
		return
	}
	err = en.WriteInt64(_encodeTimeDuration(z.Dur))
	if err != nil {
		err = msgp.WrapError(err, "Dur")
		return
	}
...
func (z TestRet) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendString(o, z.Name)
	// string "Dur"
	o = append(o, 0xa3, 0x44, 0x75, 0x72)
	o = msgp.AppendInt64(o, _encodeTimeDuration(z.Dur))
	return
}
...
func (z TestRet) Msgsize() (s int) {
	s = 1 + 5 + msgp.StringPrefixSize + len(z.Name) + 4 + msgp.Int64Size
	return
}
