...
func (z *ControlCall) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "Cancelable":
			z.Cancelable, err = dc.ReadBool()
			if err != nil {
				err = msgp.WrapError(err, "Cancelable")
				return
			}
		default:
			err = dc.Skip()
...
func (z ControlCall) EncodeMsg(en *msgp.Writer) (err error) {
	...
	// write "Cancelable"
	err = en.Append(0xaa, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x61, 0x62, 0x6c, 0x65)
	if err != nil {
		return
	}
	err = en.WriteBool(z.Cancelable)
	if err != nil {
		err = msgp.WrapError(err, "Cancelable")
		return
	}
...
func (z ControlCall) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// string "Cancelable"
	o = append(o, 0xaa, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x61, 0x62, 0x6c, 0x65)
	o = msgp.AppendBool(o, z.Cancelable)
	return
}
...
func (z *ControlCall) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "Cancelable":
			z.Cancelable, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "Cancelable")
				return
			}
...
func (z ControlCall) Msgsize() (s int) {
	s = 1 + 3 + msgp.StringPrefixSize + len(z.ID) + 4 + msgp.Uint64Size + 11 + msgp.BoolSize
	return
}
